...
const Footer = () => {
  return (
    <div className="md:h-[100px] h-[200px] bg-secondary w-full">
    
        <div className="flex items-center md:flex-row flex-col md:py-[0] py-[20px] px-[35px] gap-[20px] justify-between w-full h-full">
